...
class HomeScreen extends StatefulWidget {
  final YouTubeAPI youtubeAPI; // Tambahkan ini sebagai parameter
  const HomeScreen({Key? key, required this.youtubeAPI}) : super(key: key);
...
void initState() {
  super.initState();
  _youtubeAPI = widget.youtubeAPI.apiKey;
}
    ...
    Navigator.pushReplacement(
      ...
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) {
          switch (index) {
            case 0:
              return HomeScreen(youtubeAPI:widget.youtubeAPI);
            case 1:
              return const SearchScreen();
            case 2:
